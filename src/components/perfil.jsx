        ...
        <section className="bg-cover w-full h-full" style={divStyle}>
            <div className="flex flex-col items-center p-20   ">
                <div className="flex flex-col p-5 my-5 items-center bg-slate-800 bg-opacity-50 rounded-lg">
                  <h2 className={`text-cyan-400 text-center text-3xl md:text-4xl font-new font-bold ${isEnglish ? "block" : "hidden"}`}>Software Engineer</h2>
                  <h1 className="  text-sm text-center md:text-3xl text-white font-bold m-4 hidden">Jhonny Iriarte Condori</h1>
                  <h2 className={`text-cyan-400 text-3xl md:text-4xl font-new font-bold text-center ${isEnglish ? "hidden" : "block"}`}>Ingeniero De Software</h2>
