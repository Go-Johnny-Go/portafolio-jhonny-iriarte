        ...
        <section id="projects">
            <div className="px-5 py-10 text-center ">
                <div className="flex flex-col mb-20 gap-4 mt-10">
                    ...
                    <h1 className={`sm:text-4xl text-3xl font-bold  mb-4 text-red-600 ${isEnglish ? "block" : "hidden"}`}>
                    Some of my projects!
                    </h1>
                    <h1 className={`sm:text-4xl text-3xl font-bold  mb-4 text-red-600 ${isEnglish ? "hidden" : "block"}`}>
