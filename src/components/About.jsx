    ...
    <section id="about">
      <div className="container px-5  mx-auto">
        <div className="text-center mb-10 p-5 md:p-10 lg:p-20">
          ...
          <p className={`text-gray-200 font-raleway  text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto ${isEnglish ? "block" : "hidden"}`}>
          ...
          <p className={`text-gray-200 font-raleway  text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto ${isEnglish ? "hidden" : "block"}`}>
          ...
          <p className="text-base text-gray-200 font-raleway leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto mt-5">
